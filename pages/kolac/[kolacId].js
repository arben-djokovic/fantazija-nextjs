...
export async function getStaticPaths() {
    ...
    const res = await fetch('https://fantazija-tuzi.vercel.app/api/kolaci')
  ...
  export async function getStaticProps(constext) {
    ...
    const res = await fetch(`https://fantazija-tuzi.vercel.app/api/kolaci/${constext.params.kolacId}`)
