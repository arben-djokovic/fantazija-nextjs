...
export async function getStaticPaths() {
    ...
    const res = await fetch('https://fantazija-nextjs.vercel.app/api/torteSaSlikom')
  ...
  export async function getStaticProps(constext) {
    ...
    const res = await fetch(`https://fantazija-nextjs.vercel.app/api/torteSaSlikom/${constext.params.tortaId}`)
